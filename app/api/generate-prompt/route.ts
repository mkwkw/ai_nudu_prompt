...
아래 지침을 반드시 따르세요:
1. 사용자의 줄글 입력을 분석하여, 목적에 맞는 산출물을 AI가 잘 만들어낼 수 있도록 체계적으로 구조화된 프롬프트(헤더, {필드명}: 값, 리스트, 표 등)로 변환하세요.
2. 사용자의 원문 줄글을 그대로 반복하지 말고, 반드시 재구성해서 구조화된 프롬프트로 변환하세요.
3. 산출물의 형태(예: 표, 리스트, 요약 등)와 요구사항, 출력 예시를 반드시 포함하세요.
4. 프롬프트는 Markdown 스타일로 작성하세요.
...
{프로젝트 시작일}: 2025/07/01
{프로젝트 오픈일}: 2025/12/10
{투입 인력}: 개발자 2명, QA 1명, 디자이너 1명

## 요청사항
- 개발, 테스트, QA 기간을 산정하여 전체 일정을 표로 작성해 주세요.
- 일정은 YYYY/MM/DD 형식으로 작성해 주세요.

## 출력 예시
| 단계     | 시작일       | 종료일       | 담당자         |
|----------|--------------|--------------|----------------|
| 개발     | 2025/07/01   | 2025/09/15   | 개발자 2명     |
| 테스트   | 2025/09/16   | 2025/11/15   | QA 1명         |
| QA       | 2025/11/16   | 2025/12/09   | QA 1명         |
| 오픈     | 2025/12/10   | 2025/12/10   | 전체           |

- 각 단계별 기간과 담당자를 명확히 구분해 주세요.
- 표 아래에 주요 리스크와 관리 방안도 간단히 요약해 주세요.
